        ...
        <header>
            <nav className="container flex items-center py-4 mt-4">
                ...
                <ul className="hidden sm:flex flex-1 justify-end items-center gap-12 text-tbpp-blue uppercase text-xs">
                    ...
                    <Link to="/create-room" className="bg-tbpp-red text-white rounded-md px-7 py-3 uppercase">Try it out!</Link>
                </ul>
            ...
            <div className={`shadow rounded-md font-semibold ${mobileMenuToggled ? '' : 'hidden'} sm:hidden`}>
                <ul>
                    ...
                    <Link to="/create-room" className="py-2 px-4 text-sm hover:bg-gray-200">Try it out!</Link>
                </ul>
            </div>
        </header>
    )
